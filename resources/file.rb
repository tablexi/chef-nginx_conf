...
attribute :reload, kind_of: [String, Symbol], equal_to: [:delayed, :immediately, 'delayed', 'immediately'], default: :delayed # How soon should we restart nginx.
...
attribute :precedence, kind_of: [String, Symbol], default: :default # Level of attribute precedence to use
attribute :site_type, kind_of: [String, Symbol], equal_to: [:dynamic, :static, 'dynamic', 'static'], default: :dynamic
